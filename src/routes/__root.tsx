...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Quantis Tecnologia" },
      { property: "og:title", content: "Quantis Obras — Controle Tecnológico de Materiais" },
      ...
      { name: "twitter:title", content: "Quantis Obras — Controle Tecnológico de Materiais" },
