...
CREATE POLICY "empresas_insert" ON public.empresas_clientes FOR INSERT TO authenticated WITH CHECK (true);
...
-- catalogo
CREATE POLICY "catalogo_read_all" ON public.servicos_catalogo FOR SELECT USING (true);
...
-- tecnicos
CREATE POLICY "tecnicos_read_auth" ON public.tecnicos FOR SELECT TO authenticated USING (true);
...
-- Incrementa total_servicos_concluidos ao validar
